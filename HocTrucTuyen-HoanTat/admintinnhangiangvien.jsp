...
<html lang="en">
<head>
   <title>admin xem tin nhan giảng viên vien</title>
  <meta charset="utf-8">
    ...
    <div class="col-sm-3 sidenav">
     ...
     <div class="col-sm-9 text-left">
       <div >
          ...
          <b style="font-size:200%;">Tin nhắn giảng viên:</b>
        <thead>
          <tr>
            <th>Giảng viên</th>
            <th>Mã giảng viên</th>
        ...
        <tbody>
          ...
          <tr>
           ...
           <p><a href="admintrangchu.jsp#" class="btn btn-default" role="button">Quay lai</a> <a href="admintraloi.jsp#" class="btn btn-primary" role="button">Tra loi</a></p>
        </div>
