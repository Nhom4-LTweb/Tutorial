...
<html lang="en">
<head>
    <title>Giảng viên xem tin nhắn</title>
  <meta charset="utf-8">
     ...
     <ul class="nav nav-pills nav-stacked">
      ...
      <div class="col-sm-6 col-md-6">
        <div >
          ...
          <b style="font-size:200%;">Nguyễn văn A:</b>
          <div class="jumbotron">
                <b style="font-size:200%;">Tiêu đề:cập nhật điểm</b>
                <p style="font-size:200%;"><b>Nội dung:</b></p>
                <p> cập nhật lại điểm môn cơ sở dữ liệu cho lớp A1 khóa 2015</p>
          ...
          <p><a href="giangvientinnhan.jsp#" class="btn btn-primary" role="button">Quay lai</a> <a href="giangvientraloitinnhan.jsp#" class="btn btn-primary" role="button">Trả lời</a></p>
