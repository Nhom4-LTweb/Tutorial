...
<nav class="navbar navbar-collapse navbar-collapse">
  ...
  <form>
    ...
    <div class="text-left">
      ...
      <h1>Đăng Nhập</h1>
      <ul class="pagination">
        <li><a href="hocviendangnhap.jsp">Học viên</a></li>
        <li class="active"><a href="#">Giảng viên</a></li>
        <li><a href="admindangnhap.jsp">Admin</a></li>
      </ul>
        ...
        <div class="form-group"> 
          <div class="col-sm-offset-2 col-sm-10">
            <div class="checkbox">
              ...
              <p><a href="quenmatkhau.jsp">Quên mật khẩu</a></p>
            </div>
          </div>
        </div>
        <div class="form-group"> 
          <div class="col-sm-offset-2 col-sm-10">
            <a href="giangvientrangchu.jsp" target="_blank"><input class="btn btn-primary" type="button" value="Đăng Nhập" class="button"></a>
          </div>
        </div>
        </p>
      </form>
