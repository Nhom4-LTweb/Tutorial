...
<html lang="en">
<head>
   <title>Giảng viên trả lời tin nhắn</title>
  <meta charset="utf-8">
...
<div class="container-fluid text-left">
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
      ...
      <div class="form-group">
      <label style="font-size:200%;" for="usr">Mục trả lời tin nhắn:</label>
    </div><div class="form-group form-group-lg">
      <label for="usr">Tra loi den:</label>
      <input type="text" class="form-control" id="usr">
      <span id="helpBlock" class="help-block">Nhập Email</span>
    </div>
    <div class="form-group">
   ...
   <p><a href="giangvientinnhanchitiet.jsp#"><button type="submit" class="btn btn-primary">Quay lại</button></a><a href="giangvienhoantat.jsp#"><button type="submit" class="btn btn-primary">Gửi</button></a></p>
