            ...
            <div class="panel-group">
              ...
              <div class="panel panel-default">
                        ...
                        <div id="collapse3" class="panel-collapse collapse">
                          <ul class="list-group">
                          <li class="list-group-item"><a href="#">khóa 2012-2013</a></li>
                          <li class="list-group-item"><a href="#">khóa 2013-2014</a></li>
                          <li class="list-group-item"><a href="#">khóa 2014-2015</a></li> 
                          </ul>
                        </div>
