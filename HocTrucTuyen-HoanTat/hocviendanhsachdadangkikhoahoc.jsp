...
<div class="container-fluid text-left">
 ...
 <p><a href="hocvientrangchu.jsp"><button type="submit" class="btn btn-primary">Hủy</button></a><a href="hocvienhoantat.jsp"><button type="submit" class="btn btn-primary">Hoàn tất</button></a></p>
</div>
