  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
     <ul class="nav nav-pills nav-stacked">
      ...
      <h1 style="text-align: center">Ý kiến cá nhân </h1>
      <div class="container">
    </div>
    <div class="form-group">
      ...
      <textarea class="form-control" rows="5" id="comment"></textarea>
           ...
           <p><a href="hocvientrangchu.jsp#" class="btn btn-primary" role="button">Quay lai</a> <a href="hocvienhoantat.jsp#" class="btn btn-primary" role="button">Gửi</a></p>
        </div>
 
      <hr>
      <a href="hocvientrangchu.jsp#"><button type="submit" class="btn btn-primary">Quay lại</button></a>
