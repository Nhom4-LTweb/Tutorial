...
<html lang="en">
<head>
    <title>Giảng viên xem chi tiết học viên</title>
  <meta charset="utf-8">
...
<div class="container-fluid text-left">
  <div class="row content">
    ...
    <div class="container">
    <h2>Chi Tiet Hoc Vien:</h2>
      <div class="well well-sm">Nguyen Van A</div>
    </div>
    <div class="container">
    ...
    <ul class="pager">
      <li><a href="hocvientrangchu.jsp#">Quay lai</a></li>
      <li><a href="hocvienhoantat.jsp#">Xac nhan</a></li>
    </ul>
