...
<div class="col-sm-9 text-left">
    ...
    <hr>
      ...
      <h3>Câu 2: Khi tham gia giao thông, trường hợp nào dưới đây là không an toàn, gây nguy hiểm ? </h3>
      <form>
        <input name="gioitinh" type="radio" value="VN" />Đi qua đường cùng người lớn.<br />
        <input name="gioitinh" type="radio" value="TQ" />Không đội mũ bảo hiểm khi ngồi trên xe mô tô, xe máy.<br />
        <input name="gioitinh" type="radio" value="NB" />Đi xe đạp chở 1 người ngồi sau.<br />
      </form>
      <h3>Câu 3: Khi tham gia giao thông, trường hợp nào dưới đây là không an toàn, gây nguy hiểm ? </h3>
      <form>
        <input name="gioitinh" type="radio" value="VN" />Đi qua đường cùng người lớn.<br />
        <input name="gioitinh" type="radio" value="TQ" />Không đội mũ bảo hiểm khi ngồi trên xe mô tô, xe máy.<br />
        <input name="gioitinh" type="radio" value="NB" />Đi xe đạp chở 1 người ngồi sau.<br />
      </form>
      <h3>Câu 4: Khi tham gia giao thông, trường hợp nào dưới đây là không an toàn, gây nguy hiểm ? </h3>
      <form>
        <input name="gioitinh" type="radio" value="VN" />Đi qua đường cùng người lớn.<br />
        <input name="gioitinh" type="radio" value="TQ" />Không đội mũ bảo hiểm khi ngồi trên xe mô tô, xe máy.<br />
        <input name="gioitinh" type="radio" value="NB" />Đi xe đạp chở 1 người ngồi sau.<br />
      ...
      <p><a href="hocvienhoantat.jsp#"><button type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-open"></span>Nộp Bài</button> </a></p>
    </div>  
