...
<div class="container-fluid text-left">
  ...
  <h1 style="text-align: center"> <img src="http://storage.canalblog.com/31/09/674733/56681301.gif" alt="khong co gi het" width="100%" height="50"> </h1>
      ...
      <p style="font-size:200%;"><div class="bs-example">
		<div class="container">
		  <div style="font-size:200%;" class="well well-sm">Tin nhắn của:Nguyen Van A, 18/09/2016</div>
		</div>
		<div class="form-group">
		...
		<div class="container">
		  <ul class="pager">
		     <li><a href="#" class="btn btn-primary"><button type="submit" class="btn btn-primary">Quay lại</button></a></li>
		    <li><a href="#" class="btn btn-primary"><button type="submit" class="btn btn-primary">Trả lời</button></a></li>
