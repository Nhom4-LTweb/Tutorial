...
<html lang="en">
<head>
   <title>admin xem tin nhan giang vien</title>
  <meta charset="utf-8">
     ...
     <div class="row">
      <div class="col-sm-6 col-md-4">
        <div class="thumbnail">
          ...
          <div class="caption">
            <h3>Tin Nhắn</h3>
            <p></p>
            <p><a href="#" class="btn btn-primary" role="button">Giảng viên</a> <a href="#" class="btn btn-default" role="button">Học viên</a></p>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-md-6">
        <div >
          ...
          <b style="font-size:200%;">Tin nhan giang vien:</b>
        <thead>
          <tr>
            <th>Giang vien</th>
            <th>Ma giảng vien</th>
        ...
        <tbody>
          ...
          <tr>
           ...
           <p><a href="#" class="btn btn-default" role="button">Quay lai</a> <a href="#" class="btn btn-primary" role="button">Tra loi</a></p>
        </div>
