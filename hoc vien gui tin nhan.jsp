...
<html lang="en">
<head>
  <title>Học viên gửi tin nhắn</title>
  <meta charset="utf-8">
...
<div class="col-sm-9 text-left">
      <h1 style="text-align: center">Nhắn tin </h1>
          
      <ol>
      
           <label for="name">Name:<br/></label>
            <input type="text" class="input" id="name" placeholder="Nguyễn văn A">
          
          <label for="email"><br/>Email:</labe     l>
            <input type="text" class="input" id="name" placeholder="email">
  
      </ol>
       <label for="message"><br/>Message:</label>
            <textarea class="input textarea" id="message" placeholder="viết tin nhắn"></textarea>    
